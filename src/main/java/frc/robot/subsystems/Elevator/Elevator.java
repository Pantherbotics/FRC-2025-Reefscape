...
public class Elevator extends SubsystemBase {
  ...
  private boolean hasZeroedSinceBoot;
  ...
  public Command zeroEncoder() {
    return this.startEnd(
        ...
        () -> m_leaderMotor.setControl(new NeutralOut())).finallyDo(
            () -> {
              m_leaderMotor.setPosition(Degrees.of(0));
              hasZeroedSinceBoot = true;
              moveUnzeroed.set(false);
    ...
    return new ConditionalCommand(
        this.runOnce(() -> {
          ...
          m_leaderMotor.setControl(m_motionMagicReq.withPosition(goalAngle));
            ...
            .until(this::isAtGoal),
        this.runOnce(() -> moveUnzeroed.set(true)),
        () -> hasZeroedSinceBoot);
  }
  ...
  public void periodic() {
    SmartDashboard.putBoolean("hasZeroedSinceBoot", hasZeroedSinceBoot);
